...
public class LoungeVO {
	...
	public int getLounge_viewcount() {
		return lounge_viewcount;
	}
	public void setLounge_viewcount(int lounge_viewcount) {
		this.lounge_viewcount = lounge_viewcount;
	}
